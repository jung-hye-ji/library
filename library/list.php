...
<div class="container">
    ...
    <div class="board_list_wrap">
        <table class="board_list" width=800 border="1">
        <thead>
                <tr>
                    <th> No </th>
                    <th> 제목 </th>
            ...
            <tbody>
                <?php
                        $query = "select * from book_board order by idx desc limit 0,5";
                ...
                ?>
                    <tr>
                        <td><?=$data['idx']?></td>
                        <td class="tit"> <a href="listview.php?idx=<?=$data['idx']?>"><?=$data['subject']?></a></td>
                        <td> <?=$data['name']?> </td>
        ...
        <a href="listwrite.php" class="btn_b02">글쓰기</a>
    </div>
</div>
<footer class="footer">
